...
object grupal2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    def safeAccess(list: List[Int], index: Int): Try[Int] = {
      if (index >= 0 && index < list.length)
        ...
        Failure(new IndexOutOfBoundsException("INDICE FUERA DE RANGO"))
    }
  ...
  //OTRA FORMA DE HACER LA FUNCION 2
  def safeAccess2(list: List[Int], index: Int): Try[Int] = {
    Try(list(index)) match {
      case Success(value) => Success(value)
      case Failure(_) => Failure(new IndexOutOfBoundsException("INDICE FUERA DE RANGO"))
    }
  }

  println(safeAccess2(List(1, 2, 3, 4, 5), 2)) // Success(3)
  println(safeAccess2(List(1, 2, 3, 4, 5), 5)) // Failure(java.lang.IndexOutOfBoundsException: Índice inválido: 5)
  println(safeAccess2(List(1, 2, 3), -1)) // Failure(java.lang.IndexOutOfBoundsException: Índice inválido: -1)
  println(safeAccess2(List(), 0)) // Failure(java.lang.IndexOutOfBoundsException: Índice inválido: 0)
}
